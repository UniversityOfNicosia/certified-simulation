...
Rather than restate it in full, this page records how it applies
here.

## In practice

This is a research repository; disagreement about mathematics,
methods, and results is the point, not a problem. The expectations
that matter most here:

- **Critique claims, not people.** "Check 41 fails on my machine"
  and "I believe Theorem 3.2's hypothesis is violated because…" are
...
- **Assume good faith**, especially across fields: this repository
  ...
  engineering, and vocabulary collisions are common and innocent.
- No harassment, personal attacks, or disclosure of others' private
  information, per the Covenant.
