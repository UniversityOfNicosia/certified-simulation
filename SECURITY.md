...
Released code in this repository consists of certificate and
verification programs intended to be run locally on research data.
It operates no network services, takes no untrusted input in normal
use, and handles no credentials.

## Reporting

| | |
| --- | --- |
| **What to report** | Security-relevant problems in released code, or material in a release that should not have been published |
