...
\author[1]{\fnm{Antonis} \sur{Polemitis}}\email{polemitis.an@unic.ac.cy}

\author*[2]{\fnm{Nicholas} \sur{Christakis}}\email{christakis.n@unic.ac.cy}
%\equalcont{These authors contributed equally to this work.}

\author[2]{\fnm{Dimitris} \sur{Drikakis}}\email{drikakis.d@unic.ac.cy}
%\equalcont{These authors contributed equally to this work.}
...
\subsection*{Funding}
For this work, no internal/external funding was received.
...
The source code, numerical data, and figure-generation scripts supporting this study are publicly available in the GitHub repository
\url{https://github.com/nchrkis/FV_erasure}.  The repository contains the Python scripts used to generate all matrix tests, scalar finite-volume
experiments, CSV files, LaTeX table fragments, and figures reported in the manuscript. The repository also
contains instructions for reproducing the results.  No external CFD solver or proprietary software is required.
