...
Generative-AI systems were used for literature discovery, adversarial
mathematical review, copyediting suggestions, and assistance with
experiment and verification code.  The authors checked the cited
sources, mathematical arguments, numerical results, and final text,
and remain able to defend each of them.  The authors assume
